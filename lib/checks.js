...
export function planCommands(findings, selectedIds) {
  const order = ["location", "region.default", "regions", "regions.extra", "owner.info", "dutycycle", "path.hash.mode", "advert.interval", "flood.advert.interval", "guest.password", "loop.detect", "flood.max.unscoped", "cad", "radio.rxgain", "radio.fem.rxgain", "agc.reset.interval", "rxdelay", "txdelay", "direct.txdelay", "radio"];
