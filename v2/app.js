// app.js - the guided version of meshguide.dk (v2/).
//
...
//
// Nothing about talking to devices lives here: serial.js / ble.js / remote-cli.js
// do the talking, checks.js holds the rules, flow.js the read -> map ->
// recommend -> apply part. This file is the guide around them.

import { MeshCoreSerial, serialSupported } from "../automagical/serial.js";
import { MeshCoreBle, bluetoothSupported } from "../automagical/ble.js";
import { RemoteCli } from "../automagical/remote-cli.js";
import { createContactPicker } from "../automagical/contacts-ui.js";
import { $, BRAVE_BLE_FLAG, CANCEL_MESSAGES, createFlow, createLog, escapeHtml, installCopyButtons, setProgress, showConnectError, showError } from "../automagical/flow.js";
import { BEST_PRACTICE, formatRadio, roleLabel } from "../automagical/checks.js";
...
async function renderDefaults() {
  ...
  // City markers (chat rooms), as on the front page.
  try {
    const cities = await fetchJSON("../cities.json");
